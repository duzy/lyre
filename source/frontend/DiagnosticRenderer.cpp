...
//#include "lyre/edit/Commit.h"
//#include "lyre/edit/EditedSource.h"
//#include "lyre/edit/EditsReceiver.h"
    ...
    const LangOptions &LangOpts) 
{
    ...
    unsigned MacroTokenLength = 0; //Lexer::MeasureTokenLength(Loc, SM, LangOpts);
