...
#include "lyre/base/OperatorKinds.h"
...
unsigned llvm::DenseMapInfo<lyre::Selector>::getHashValue(lyre::Selector S) {
...
#if 0
const char *lyre::getOperatorSpelling(OverloadedOperatorKind Operator) {
  switch (Operator) {
  case OO_None:
...
#include "lyre/base/OperatorKinds.def"
  }

  llvm_unreachable("Invalid OverloadedOperatorKind!");
}

StringRef lyre::getNullabilitySpelling(NullabilityKind kind, bool isContextSensitive) 
{
  switch (kind) {
