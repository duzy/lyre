...
#include "lyre/base/VirtualFileSystem.h"
...
namespace {
    class RealFSDirIter : public lyre::vfs::detail::DirIterImpl {
        std::string Path;
...
lyre::vfs::detail::DirIterImpl::~DirIterImpl() { }

namespace {
    class OverlayFSDirIterImpl : public lyre::vfs::detail::DirIterImpl {
...
namespace {
    ...
    class VFSFromYamlDirIterImpl : public lyre::vfs::detail::DirIterImpl 
    {
        std::string Dir;
        VFSFromYAML &FS;
