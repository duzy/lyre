...
#ifndef LLVM_LYRE_LEX_PTHMANAGER_H
#define LLVM_LYRE_LEX_PTHMANAGER_H
...
namespace lyre
{
    ...
    /// http://lyre.llvm.org/docs/PTHInternals.html
    ...
    public:
        ...
        static PTHManager *Create(llvm::StringRef file, DiagnosticsEngine &Diags);
