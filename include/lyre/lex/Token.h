...
#ifndef __LYRE_LEX_TOKEN_H____DUZY__
#define __LYRE_LEX_TOKEN_H____DUZY__ 1

#include "lyre/base/OperatorKinds.h"
#include "lyre/base/SourceLocation.h"
//#include "lyre/base/TemplateKinds.h"
...
namespace llvm {
  template <>
  struct isPodLike<lyre::Token> { static const bool value = true; };
}  // end namespace llvm

#endif//__LYRE_LEX_TOKEN_H____DUZY__
