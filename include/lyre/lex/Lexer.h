...
#ifndef LLVM_LYRE_LEX_LEXER_H
#define LLVM_LYRE_LEX_LEXER_H

#include "lyre/base/LangOptions.h"
#include "lyre/lex/Token.h"
...
public:
  ...
  Lexer(LangOptions &Opts, SourceManager &SM, FileID FID,
  ...
  static Lexer *Create_PragmaLexer(LangOptions &Opts, 
                                   SourceManager &SM,
...
public:
  ...
  static std::pair<unsigned, bool> ComputePreamble(llvm::StringRef Buffer,
                                                   const LangOptions &LangOpts,
                                                   unsigned MaxLines = 0);
