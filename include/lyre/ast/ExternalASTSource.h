...
//
//===----------------------------------------------------------------------===//
#ifndef __LYRE_AST_EXTERNALASTSOURCE_H____DUZY__
#define __LYRE_AST_EXTERNALASTSOURCE_H____DUZY__ 1

#include "lyre/ast/CharUnits.h"
#include "lyre/ast/DeclBase.h"
...
template<typename Owner, typename T,
         void (lyre::ExternalASTSource::*Update)(Owner)>
struct PointerLikeTypeTraits<
    lyre::LazyGenerationalUpdatePtr<Owner, T, Update>> {
  typedef lyre::LazyGenerationalUpdatePtr<Owner, T, Update> Ptr;
...
#endif//__LYRE_AST_EXTERNALASTSOURCE_H____DUZY__
