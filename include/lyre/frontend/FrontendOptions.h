...
#ifndef __LYRE_FRONTEND_FRONTENDOPTIONS_H____DUZY__
#define __LYRE_FRONTEND_FRONTENDOPTIONS_H____DUZY__ 1

#include "lyre/frontend/CommandLineSourceLoc.h"
...
#endif//__LYRE_FRONTEND_FRONTENDOPTIONS_H____DUZY__
