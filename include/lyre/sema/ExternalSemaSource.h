...
//
//===----------------------------------------------------------------------===//
#ifndef __LYRE_SEMA_EXTERNALSEMASOURCE_H____DUZY__
#define __LYRE_SEMA_EXTERNALSEMASOURCE_H____DUZY__ 1

#include "lyre/ast/ExternalASTSource.h"
#include "lyre/ast/Type.h"
#include "lyre/sema/Weak.h"
...
#endif//__LYRE_SEMA_EXTERNALSEMASOURCE_H____DUZY__
