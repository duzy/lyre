...
#ifndef __LYRE_BASE_IDENTIFIERTABLE_H____DUZY__
#define __LYRE_BASE_IDENTIFIERTABLE_H____DUZY__ 1

#include "lyre/base/TokenKinds.h"
...
namespace llvm 
{
    ...
    /// DenseSets.
    template <>
    struct DenseMapInfo<lyre::Selector>
    {
        static inline lyre::Selector getEmptyKey() {
            return lyre::Selector::getEmptyMarker();
        }
        static inline lyre::Selector getTombstoneKey() {
            return lyre::Selector::getTombstoneMarker();
        }

        static unsigned getHashValue(lyre::Selector S);

        static bool isEqual(lyre::Selector LHS, lyre::Selector RHS) {
            return LHS == RHS;
        }
    };

    template <>
    struct isPodLike<lyre::Selector> { static const bool value = true; };

    template <typename T> class PointerLikeTypeTraits;

    template<>
    class PointerLikeTypeTraits<lyre::Selector>
    {
    public:
        static inline const void *getAsVoidPointer(lyre::Selector P) {
            return P.getAsOpaquePtr();
        }
        static inline lyre::Selector getFromVoidPointer(const void *P) {
            return lyre::Selector(reinterpret_cast<uintptr_t>(P));
        }
    ...
    template<>
    class PointerLikeTypeTraits<lyre::IdentifierInfo*>
    {
    public:
        static inline void *getAsVoidPointer(lyre::IdentifierInfo* P) {
            return P;
        }
        static inline lyre::IdentifierInfo *getFromVoidPointer(void *P) {
            return static_cast<lyre::IdentifierInfo*>(P);
        }
        enum { NumLowBitsAvailable = 1 };
    };

    template<>
    class PointerLikeTypeTraits<const lyre::IdentifierInfo*>
    {
    public:
        static inline const void *getAsVoidPointer(const lyre::IdentifierInfo* P) {
            return P;
        }
        static inline const lyre::IdentifierInfo *getFromVoidPointer(const void *P) {
            return static_cast<const lyre::IdentifierInfo*>(P);
        }
        enum { NumLowBitsAvailable = 1 };
    };
...
#endif//__LYRE_BASE_IDENTIFIERTABLE_H____DUZY__
