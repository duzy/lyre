...
#ifndef __LYRE_FRONTEND_VERIFYDIAGNOSTICCONSUMER_H____DUZY__
#define __LYRE_FRONTEND_VERIFYDIAGNOSTICCONSUMER_H____DUZY__ 1
...
#endif//__LYRE_FRONTEND_VERIFYDIAGNOSTICCONSUMER_H____DUZY__
