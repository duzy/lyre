...
#ifndef __LYRE_BASE_FILESYSTEMSTATCACHE_H____DUZY__
#define __LYRE_BASE_FILESYSTEMSTATCACHE_H____DUZY__ 1
...
#endif//__LYRE_BASE_FILESYSTEMSTATCACHE_H____DUZY__
