...
///
/// \file
/// \brief Defines the lyre::Visibility enumeration and various utility
/// functions.
///
//===----------------------------------------------------------------------===//
#ifndef __LYRE_BASE_VISIBILITY_H____DUZY__
#define __LYRE_BASE_VISIBILITY_H____DUZY__ 1

#include "lyre/base/Linkage.h"
...
#endif // __LYRE_BASE_VISIBILITY_H____DUZY__
