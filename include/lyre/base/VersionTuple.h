...
///
/// \file
/// \brief Defines the lyre::VersionTuple class, which represents a version in
/// the form major[.minor[.subminor]].
///
//===----------------------------------------------------------------------===//
#ifndef __LYRE_BASE_VERSIONTUPLE_H____DUZY__
#define __LYRE_BASE_VERSIONTUPLE_H____DUZY__ 1
...
#endif // __LYRE_BASE_VERSIONTUPLE_H____DUZY__
