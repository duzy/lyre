//===--- lyre/base/CharInfo.h - Classifying ASCII Characters ----*- c++ -*-===//
//
...
#ifndef __LYRE_BASE_CHARINFO_H____DUZY__
#define __LYRE_BASE_CHARINFO_H____DUZY__ 1
...
namespace lyre 
{
    ...
    LLVM_READONLY static inline bool isValidIdentifier(llvm::StringRef S) 
    {
...
#endif//__LYRE_BASE_CHARINFO_H____DUZY__
